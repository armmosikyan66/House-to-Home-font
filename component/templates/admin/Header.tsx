...
const Header: FC<{}> = () => {
    return (<header className="main-header shadow-none shadow-lg-xs-1 bg-white position-relative d-none d-xl-block">
            <div className="container-fluid">
                <nav className="navbar navbar-light py-0 row no-gutters px-3 px-lg-0">
                    ...
                    <div className="col-md-6 d-flex flex-wrap justify-content-md-end order-0 order-md-1">
                        ...
                        <div
                            className="dropdown no-caret py-3 px-3 px-sm-6 d-flex align-items-center justify-content-end notice">
